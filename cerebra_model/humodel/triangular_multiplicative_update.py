...
from cerebra_model.humodel.primitives import Linear, LayerNorm, cuda_autocast
from cerebra_model.utils.chunk_utils import chunk_layer
from cerebra_model.utils.precision_utils import is_fp16_enabled
from cerebra_model.utils.tensor_utils import add, permute_final_dims
    ...
    def _inference_forward(self,
        ...
        if(inplace_chunk_size is not None):
            ...
            def flip_z_cache_(z_cache, z):
                ...
                z_cache[as_index(first_half_slicer)] = quadrant_3
                ...
                z_cache[as_index(quadrant_3_slicer)] = quadrant_4
            ...
            z_cache.copy_(z[as_index(z_cache_slicer)])
            ...
            for i, offset in combined_range_with_offsets:
                ...
                if(b_chunk_dim == col_dim):
                    ...
                    if(not z_cache_rotated):
                        ...
                        z_chunk_b[as_index(z_chunk_slicer)] = slice_tensor(
