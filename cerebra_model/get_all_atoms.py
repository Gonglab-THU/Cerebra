...
from cerebra_model.np import protein
import cerebra_model.np.residue_constants as rc
...
from cerebra_model.config import NUM_RES, NUM_EXTRA_SEQ, NUM_TEMPLATES, NUM_MSA_SEQ
...
def torsion_angles_to_frames(
    ...
    # print('default_4x4',default_4x4.shape)
    # [*, N, 8] transformations, i.e.
    #   One [*, N, 8, 3, 3] rotation matrix and
    #   One [*, N, 8, 3]    translation matrix
    default_r = r.from_tensor_4x4(default_4x4)
    # print('default_r',default_r.shape)
...
def compute_sidechain_fape(
    ...
    normed_error = normed_error / (eps + torch.sum(all_pos_mask, dim=-1))
